...
#Home Page
if rad=="Home":
    st.title('Comprehensive Text Analysis')
    st.image('D:\Comprehensive Text Analysis\Complete Text Analysis Home Page.jpg')
    st.text(" ")
...
df1=pd.read_csv("D:\Comprehensive Text Analysis\Spam Detection.csv")
...
df2=pd.read_csv("D:\Comprehensive Text Analysis\Sentiment Analysis.csv")
...
df3=pd.read_csv("D:\Comprehensive Text Analysis\Stress Detection.csv")
...
df4=pd.read_csv("D:\Comprehensive Text Analysis\Hate Content Detection.csv")
...
df5=pd.read_csv("D:\Comprehensive Text Analysis\Sarcasm Detection.csv")
